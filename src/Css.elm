...
{-| Sets [`gap`](https://developer.mozilla.org/en-US/docs/Web/CSS/gap) with separate
row-gap and column-gap values.

    gap2 (px 10) (px 10)

-}
gap2 : Length compatibleA unitsA -> Length compatibleB unitsB -> Style
gap2 =
    prop2 "gap"
...
{-| Sets [`column-count`](https://developer.mozilla.org/en-US/docs/Web/CSS/column-count)

    columnCount (int 3)

-}
columnCount : IntOrAuto compatible -> Style
columnCount =
    prop1 "column-count"


{-| Sets [`column-width`](https://developer.mozilla.org/en-US/docs/Web/CSS/column-width)

    columnWidth (px 200)

-}
columnWidth : LengthOrAuto compatible -> Style
columnWidth =
    prop1 "column-width"


{-| Sets [`column-rule-color`](https://developer.mozilla.org/en-US/docs/Web/CSS/column-rule-color)

    columnRuleColor transparent

-}
columnRuleColor : ColorValue compatible -> Style
columnRuleColor c =
    property "column-rule-color" c.value


{-| Sets [`column-rule-style`](https://developer.mozilla.org/en-US/docs/Web/CSS/column-rule-style)

    columnRuleStyle solid

-}
columnRuleStyle : BorderStyle compatible -> Style
columnRuleStyle =
    prop1 "column-rule-style"


{-| Sets [`column-rule-width`](https://developer.mozilla.org/en-US/docs/Web/CSS/column-rule-width)

    columnRuleWidth (px 2)

-}
columnRuleWidth : Length compatible units -> Style
columnRuleWidth =
    prop1 "column-rule-width"
